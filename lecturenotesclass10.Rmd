...
Blue marble: 3/8 or 37.5%
White marble: 1/8 or 12.5%
Red marble: 4/8 or 50%
...
I think there is a greater probability that the square of dice roll 1 is equal 
to dice roll 2.
...
```{r identify_events}
dice_roll <- dice_roll %>%
  mutate(dice_match = roll_1 == roll_2,
         abs_4 = abs(roll_1 - roll_2) == 4)
...
Actual answer: more likely for the number on the dice to match than for the 
absolute value of the difference between the number on dice 1 and dice 2 to be 
4.
